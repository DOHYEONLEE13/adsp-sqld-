  ...
  steps: [
    ...
    },
    {
          ...
          dialogue: [
                ...
                {
                      pose: "think",
                      text: "[유형]은 만질 수 있는 대상, [개념]은 생각으로 구분하는 대상, [사건]은 어떤 일이 발생한 기록이야."
                },
                {
                      pose: "happy",
                      text: "학생은 유형, 학과는 개념, 수강신청은 사건으로 보면 쉬워."
                },
                {
                      pose: "idle",
    ...
    },
    {
          ...
          dialogue: [
                ...
                {
                      pose: "think",
                      text: "학생 엔터티라면 학번, 이름, 학과, 연락처 같은 값들이 속성이야."
                },
                {
                      pose: "lightbulb",
                      text: "DB 표로 보면 속성은 보통 [컬럼]이 돼."
                },
                {
                      pose: "idle",
                      text: "속성의 의미를 확인해보자."
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "속성은 엔터티를 설명하는 세부 정보입니다. 학생이라는 대상을 관리하려면 학번·이름·학과처럼 여러 속성이 필요합니다."
                },
                {
                      kind: "example",
                      title: "표로 보면",
                ...
                },
                {
                      ...
                      tone: "tip",
                      title: "원자성",
                      body: "한 속성에는 하나의 의미만 담는 것이 좋습니다. 전화번호 여러 개를 한 칸에 몰아넣으면 나중에 검색과 수정이 어려워집니다."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "속성은 만들어진 방식으로 [기본], [설계], [파생]으로 나눠."
                },
                {
                      pose: "lightbulb",
                      text: "이름은 기본, 주문번호는 설계, 총점은 파생처럼 보면 쉬워."
                },
                {
                      pose: "happy",
                      text: "[파생]은 다른 값으로 계산해서 만든 속성이야."
                },
                {
                      pose: "idle",
                      text: "계산으로 만든 속성을 찾아보자."
                }
          ],
          blocks: [
                {
                ...
                },
                {
                      ...
                      tone: "warn",
                      title: "파생 속성 주의",
                      body: "파생 속성은 편하지만 원본이 바뀌면 다시 계산해야 하므로 많이 만들수록 관리 부담이 늘어납니다."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "이번에는 속성을 쪼갤 수 있는지로 나눠보자."
                },
                {
                      pose: "lightbulb",
                      text: "[단일]은 하나의 값, [복합]은 더 쪼갤 수 있는 값, [다중값]은 여러 값을 가질 수 있는 경우야."
                },
                {
                      pose: "happy",
                      text: "주소는 복합, 전화번호 여러 개는 다중값으로 생각하면 돼."
                },
                {
                      pose: "idle",
                      text: "다중값 속성을 골라보자."
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "tip",
                      title: "모델링 감각",
                      body: "다중값은 보통 별도 테이블로 분리해 관리합니다."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "속성은 테이블 안에서 맡은 역할로도 나눠."
                },
                {
                      pose: "lightbulb",
                      text: "[PK]는 행을 구분하고, [FK]는 다른 테이블을 가리키고, [일반]은 나머지 정보야."
                },
                {
                      pose: "happy",
                      text: "학생의 학번은 PK, 학과ID는 FK가 될 수 있어."
                },
                {
                      pose: "idle",
                      text: "FK의 역할을 확인해보자."
    ...
    },
    {
          ...
          dialogue: [
                ...
                {
                      pose: "lightbulb",
                      text: "관계는 ERD에서 선으로 보이지만, 그 선 안에도 의미가 있어."
                },
                {
                      pose: "idle",
                      text: "관계의 의미를 확인해보자."
    ...
    },
    {
          ...
          dialogue: [
                ...
                {
                      pose: "lightbulb",
                      text: "[주/보조], [내부/외부], [단일/복합], [본질/인조]."
                },
                {
                      pose: "happy",
                      text: "대표인가, 어디서 왔나, 몇 개로 만들었나, 자연값인가 인공값인가를 보는 거야."
                },
                {
                      pose: "idle",
                      text: "분류 기준을 맞춰보자."
    ...
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "[식별자 관계]는 부모의 식별자가 자식의 식별자 일부가 되는 관계야."
                },
                {
                      pose: "lightbulb",
                      text: "예: 학생 + 과목이 모여 수강신청의 PK가 되는 경우를 떠올려봐."
                },
                {
                      pose: "happy",
                      text: "부모 없이는 자식도 구분하기 어려운 강한 관계야."
                },
                {
                      pose: "idle",
                      text: "식별자 관계의 특징을 골라보자."
                }
          ],
          blocks: [
                {
                      kind: "intro",
                      body: "식별자 관계에서는 부모 엔터티의 주식별자가 자식 엔터티의 주식별자에 포함됩니다."
                },
                {
                      kind: "example",
                      title: "수강신청 예시",
                      body: "수강신청이 (학번, 과목코드)로 식별된다면 학생의 학번과 과목의 과목코드가 자식의 PK 일부가 됩니다."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "[비식별자 관계]에서는 부모의 식별자가 자식의 일반 속성으로 들어가."
                },
                {
                      pose: "lightbulb",
                      text: "자식은 자기 PK를 따로 가지고, 부모 값은 FK로만 참조하는 구조야."
                },
                {
                      pose: "happy",
                      text: "그래서 식별자 관계보다 약한 연결로 볼 수 있어."
                },
                {
                      pose: "idle",
                      text: "비식별자 관계를 골라보자."
