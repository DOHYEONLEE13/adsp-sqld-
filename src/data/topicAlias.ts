 ...
 *
 * 2026-05-05 갱신 — Phase A 의 markdown topic propagation 후 추가된
 * lesson-step-group derived granular topics 흡수.
 * 결정 이력: reports/decisions/2026-05-05T23-04_topicAlias_regression.md
 */
const ADSP_ALIAS: AliasTable = {
  1: {
    ...
    'OLTP/OLAP': '데이터의 이해',
    'SECI 모델': '데이터의 이해',
    // 1-1 추가 (2026-05-05, Phase A 후 lesson-step granular topics)
    '데이터 분류 (개요)': '데이터의 이해',
    '기업 데이터베이스': '데이터의 이해',
    '암묵지 · 형식지': '데이터의 이해',
    'DB 4특징': '데이터의 이해',
    ...
    // 1-2 추가 (2026-05-05)
    '빅데이터 비유': '데이터의 가치와 미래',
    '빅데이터 단위 암기': '데이터의 가치와 미래',
    '빅데이터가 만들어내는 변화': '데이터의 가치와 미래',
    '데이터 3법': '데이터의 가치와 미래',
    ...
    // 1-3 추가 (2026-05-05)
    'DS 6역량': '가치 창조를 위한 데이터 사이언스',
    '핵심 3축': '가치 창조를 위한 데이터 사이언스',
    'Hard Skill vs Soft Skill': '가치 창조를 위한 데이터 사이언스',
  },
  2: {
    // 2-1 데이터 분석 기획의 이해
    '분석 기획': '데이터 분석 기획의 이해',
    ...
    '하향식 접근': '분석 과제 발굴',
    '탐색적 데이터 분석': '분석 과제 발굴',
    // 2 추가 (2026-05-05, Phase A 후 lesson-step granular topics)
    '분석 방법론 5종': '데이터 분석 기획의 이해',
    '분석 4유형 (개요)': '데이터 분석 기획의 이해',
    '분석 프로세스': '데이터 분석 기획의 이해',
    '분석 거버넌스': '분석 마스터플랜',
    '과제 우선순위 (개요)': '분석 마스터플랜',
    '타당성 3요소': '분석 과제 발굴',
    '상향식 접근': '분석 과제 발굴',
  ...
  3: {
    ...
    '연관분석': '정형 데이터 마이닝',
    '연관규칙': '정형 데이터 마이닝',
    // 3 추가 (2026-05-05, Phase A 후 lesson-step granular topics)
    'R 자료구조': 'R 기초와 데이터 마트',
    '요약변수 vs 파생변수': 'R 기초와 데이터 마트',
    '과적합 / 데이터 분할': 'R 기초와 데이터 마트',
    '측정 척도': '통계 분석',
    '확률분포': '통계 분석',
    '회귀 4가정': '통계 분석',
    '시계열 4성분': '통계 분석',
    ...
    't검정 3종': '통계적 가설 검정',
    '군집': '정형 데이터 마이닝',
    '평가지표 ① 오분류표': '정형 데이터 마이닝',
    'K-최근접이웃 (K-NN)': '정형 데이터 마이닝',
    '나이브베이즈 분류기 (NBC)': '정형 데이터 마이닝',
    '서포트 벡터 머신 (SVM)': '정형 데이터 마이닝',
    '인공신경망 · 딥러닝': '정형 데이터 마이닝',
  },
};
