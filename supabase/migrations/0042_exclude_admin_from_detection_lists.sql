-- 0042 — Exclude admin QA accounts from dashboard detection lists.
--
-- Top-level totals can still reflect all profiles, but abuse/usage detection
-- panels should represent real user behavior. Admin QA sessions are operational
-- noise and must not appear in those lists.
