      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'DIKW 피라미드는 데이터가 의사결정에 쓰이기까지의 가공 단계를 4 층으로 정리한 모델이야. 아래로 갈수록 양은 많고 가치는 낮으며, 위로 갈수록 양은 줄지만 의사결정에 직접 쓰여.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
          title: '"데정지혜" 로 외우자',
          body:
            '데이터(Data) → 정보(Information) → 지식(Knowledge) → 지혜(Wisdom). 시험에 순서를 묻는 문제가 자주 나와.',
        },
        {
          kind: 'table',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터(Data) 는 측정·관찰·기록의 결과 그 자체야. 어떤 의미나 해석도 붙지 않은 원시 값이야. 마트에 가서 가격표를 본 그 순간, 체중계 위에 올라가서 숫자가 표시된 그 순간 — 그게 데이터야.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
          body:
            '편의점 영수증의 "삼다수 800원" / 체중계 화면의 "68.4kg" / 출석부에 찍힌 "9시 02분 출근" / 기상청 센서가 기록한 "오전 9시 기온 21.3℃". 모두 단일 측정값이야. 다른 값과 비교하지도, "그래서 뭐?" 라는 의미를 붙이지도 않은 상태.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          ...
          body:
            '"~원", "~kg", "~℃" 처럼 단일 값만 등장하고 다른 값과의 비교가 없다면 데이터 단계야. "B마트가 300원 싸다" 처럼 비교가 시작되면 다음 단계(정보) 로 넘어간 것.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '정보(Information) 는 여러 데이터를 비교·집계·맥락 안에 놓아 "그래서 어떤 뜻이지?" 가 드러난 단계야. 데이터가 점이라면 정보는 점들을 잇는 선. 한 번 비교가 일어나는 순간 데이터는 정보로 승격해.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
          body:
            '"이번 주 평균 매출 320만원, 지난 주 280만원 → 14% 증가" / "이 학생의 수학 점수 85점, 반 평균 72점 → 평균보다 13점 높음" / "오늘 강수량 50mm, 6월 평균 60mm → 평균보다 적은 비". 모두 단일 값이 아니라 비교·집계가 들어 있어.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          ...
          body:
            '"이번엔 ~가 더 ~하다" 까지가 정보. "다음에도 ~가 더 ~할 것" 처럼 미래에 적용되는 규칙으로 굳어지면 다음 단계(지식). 한 번의 비교 결과인지 여러 번 통하는 룰인지로 갈라.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '지식(Knowledge) 은 여러 정보를 묶어 "이런 상황엔 이렇게 한다" 라는 규칙·패턴으로 굳힌 단계야. 정보가 "이번에 어떻더라" 의 일회성 관찰이라면 지식은 "다음에도 그럴 것" 의 반복 가능한 룰.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '지혜(Wisdom) 는 검증된 지식을 새로운 영역으로 확장하는 창의적 추론이야. 직접 비교한 적 없는 영역까지 같은 룰이 통할 거라 미루어 짐작하는 통찰. DIKW 의 가장 위, 양은 가장 적지만 가치는 가장 높아.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '"고객 리뷰 텍스트는 어떤 데이터인가?" 같은 시험 문제는 한 마디로는 답이 안 돼. 같은 데이터를 세 가지 다른 관점으로 묻거든요. (1) 어떻게 정리돼 있나(형태) (2) 숫자인가 말인가(표현 방식) (3) 무엇을 의미하나(분석 목적) — 이 세 축에 각각 답해야 완전한 분류가 돼.',
        },
        {
          kind: 'section',
          title: '예시로 한 번에 — "고객 리뷰 텍스트"',
          body:
            '같은 "고객 리뷰 텍스트" 를 3축으로 답해보면: 형태 = 비정형(미리 정해진 행·열 없음) · 표현 방식 = 정성적(숫자가 아닌 자연어) · 분석 목적 = 범주형(특정 단어/감정 라벨로 분류). 한 데이터에 답이 3개 동시에 붙는다는 게 핵심이야.',
        },
        {
          kind: 'table',
          title: '3축 한눈에',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '정형(Structured) 은 미리 정한 행·열 구조에 딱 맞춰 저장된 데이터야. 키워드는 [구조화]. 이름·학번·전공이라는 열이 정해져 있고, 모든 학생이 같은 형식으로 한 행씩 들어가요. 컴퓨터가 가장 다루기 쉬운 형태 — SQL 한 줄로 검색·집계가 돼.',
        },
        {
          kind: 'section',
          title: '대표 예시',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '반정형(Semi-structured) 은 미리 정해진 행·열 구조는 없지만 데이터 자체에 [메타데이터] (키·태그·항목 이름) 가 함께 들어있는 형태야. 키워드는 [메타데이터]. "규칙은 있는데 모양은 자유롭다" — 같은 키 이름을 쓰지만 메시지마다 길이·내용이 달라요.',
        },
        {
          kind: 'section',
          title: '대표 예시',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '비정형(Unstructured) 은 미리 정해진 행·열 구조나 키-값 형식이 전혀 없는 데이터야. 사람은 의미를 바로 알아채지만 컴퓨터 입장에선 그냥 바이트(0과 1) 의 긴 묶음이야. 분석에 쓰려면 텍스트 추출·이미지 인식 같은 가공 단계가 먼저 필요해.',
        },
        {
          kind: 'section',
          title: '대표 예시',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '정량적(Quantitative) 은 숫자로 측정 가능한 데이터야. 키워드는 [측정값]. 평균·합계·표준편차 같은 통계 연산이 자연스럽게 적용돼. "더하기·평균이 의미가 있나?" 라고 자문해서 의미가 있으면 정량적.',
        },
        {
          kind: 'section',
          title: '대표 예시',
          body:
            '· 키 175cm · 월 매출 300만 원 · 페이지 체류시간 42초 · 쇼핑 카트 수량 3개 · 강수량 50mm. 모두 명확한 측정 단위가 있고, 평균을 내거나 합산하는 게 자연스러워.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '정성적(Qualitative) 은 말·감정·서술처럼 숫자가 아닌 자연어 형태로 표현된 데이터야. 분석할 땐 텍스트 마이닝·감성 분석·코딩(범주화) 같은 별도 처리가 필요해.',
        },
        {
          kind: 'section',
          title: '대표 예시',
          body:
            '· SNS 게시글 (트위터·인스타·페이스북) · 뉴스 기사 본문 · 블로그 포스트 · 댓글 · 자유 응답 리뷰 ("배송이 빠르고 직원이 친절해"). 모두 자연어 텍스트로, 평균이나 합계가 의미 없는 — 의미 자체가 메시지인 데이터.',
        },
        {
          kind: 'callout',
          tone: 'warn',
          title: '함정 — "정성적 = 비정형" 아님',
          body:
            '정성적과 비정형은 다른 축이야. 학점(A·B·C·D), 만족도 5단계 같은 등급 코드는 정성적(말·감정 표현) 이지만 미리 정해진 라벨로 [정형] 화 돼 있어. 정성적 + 정형 의 좋은 예. 두 축을 섞어 묻는 게 시험 단골 함정.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '수치형(Numerical) 은 값 자체가 크기·차이·비율의 의미를 가지는 데이터야. 키워드는 [연산 가능]. 산술 연산(평균·합계·차이) 이 자연스럽게 통하면 수치형이야.',
        },
        {
          kind: 'section',
          title: '두 갈래 — 이산형 / 연속형',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '범주형(Categorical) 은 값이 카테고리·라벨인 데이터야. 키워드는 [라벨]. 평균이나 합계가 의미 없어 — A·B·O·AB 의 평균은 정의되지 않으니까요.',
        },
        {
          kind: 'section',
          title: '두 갈래 — 명목형 / 순서형',
        ...
        },
        {
          ...
          body:
            '"1=서울, 2=부산, 3=대구" 처럼 코드로 1·2·3 이 적혀 있어도 그건 라벨일 뿐 범주형이야. (1+3)/2 = 2 = "부산" 이라는 평균은 말이 안 되니까요. 시험에선 "숫자가 적혀 있다 = 수치형" 으로 속이는 함정 자주 등장.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '자전거 타는 법은 책으로 옮기기 어렵지만 누구나 탈 수 있어. 몸이 배운 노하우 — 이게 [암묵지]. 매뉴얼·논문처럼 글로 정리된 게 [형식지]. 두 종류 지식의 구분이 ADsP 시험의 출발점이야.',
        },
        {
          kind: 'section',
          title: '① 암묵지 (Tacit Knowledge)',
          body:
            '머리·몸 안에 있어 [말로 다 옮기기 어려운] 노하우. 직접 따라해보거나 옆에서 보며 익혀야 전해져. 예: 자전거 타는 법, 베테랑 셰프의 칼질 감, 운동 선수의 폼 감각.',
        },
        {
          kind: 'section',
          title: '② 형식지 (Explicit Knowledge)',
          body:
            '글·도식·매뉴얼로 [명확히 표현된] 지식. 누구든 읽으면 바로 전해져. 예: 입문서, 표준 작업 매뉴얼, 위키피디아 항목, 논문, 레시피북.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'SECI 모델 — 암묵지와 형식지가 [4단계] 로 순환하며 조직의 지식이 자란다는 이론. 4단계 영문 첫 글자가 S·E·C·I 라서 SECI. 한국어로는 [공표연내] 로 외워.',
        },
        {
          kind: 'table',
          title: '4단계 한 줄 요약',
        ...
        },
        {
          ...
          title: '"공표연내"',
          body:
            'Socialization(공동화) → Externalization(표출화) → Combination(연결화) → Internalization(내면화). 시험에 4단계 매핑이 자주 등장해.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '공동화(Socialization) — 머리 속이나 몸에 있는 노하우(암묵지) 가 다른 사람의 머리·몸으로 그대로 옮겨가는 단계야. 중요한 건 "글로 적힌 게 없다" 는 점이야. 같이 보고 따라하고, 시행착오를 옆에서 지켜보며 익혀.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
        ...
        },
        {
          ...
          title: '시험 식별 키워드',
          body:
            '"어깨너머", "옆에서 직접 보여주며", "도제식". 어딘가에 매뉴얼이나 문서가 등장하면 공동화 아님 — 표출화/연결화/내면화로 가야 해.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '표출화(Externalization) — 사람 안(암묵지) 에 머물던 지식을 처음으로 외부의 형태(글·도식·매뉴얼) 로 꺼내는 단계야. 영어 단어 그대로 "externalize = 밖으로 끄집어 낸다". 조직이 한 사람의 노하우에 의존하지 않고 자산화 하는 결정적 단계여서, SECI 4단계 중 시험에 가장 자주 등장해.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '연결화(Combination) — 이미 형식지(=글) 로 존재하는 여러 자료를 결합·재구성·요약해 새로운 형식지를 만드는 단계야. 글 → 글 의 변환이라는 점이 핵심이야. 사람 머리 속의 새 노하우를 끌어내는 게 아니라, 흩어진 글들을 묶어 새 그림을 그리는 작업.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '내면화(Internalization) — 글·매뉴얼·교본 같은 형식지를 읽고 실제로 반복 적용해 자기 몸·머리에 체화하는 단계야. 글 → 사람 안. 표출화(사람 → 글) 의 반대 방향이야. SECI 사이클이 한 바퀴 돌아 다시 새로운 암묵지가 만들어지는 마무리 단계.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'SECI 4단계 종합 정리. 시험에선 사례를 하나 던져주고 어느 단계인지 묻는 [매핑] 문제가 가장 흔해. 핵심은 "지식의 출발점과 도착점이 암묵인지 형식인지" 를 빠르게 가르는 것.',
        },
        {
          kind: 'table',
          title: '한 줄 매핑 복습',
        ...
        },
        {
          ...
          title: '시험 1순위 — 표출화',
          body:
            '4단계 중 시험에 가장 자주 등장하는 건 [표출화] (암묵 → 형식). "장인의 노하우를 매뉴얼로", "베테랑의 비법을 가이드북으로" 같은 표현이 나오면 표출화야.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터베이스(DB) 는 동시에 여러 사용자의 요구에 대응하여 데이터를 체계적으로 저장·관리할 수 있도록 설계된 [데이터의 집합] 이야. 4가지 본질 특징이 ADsP 시험 단골 — [공통저변] 으로 외우면 끝.',
        },
        {
          kind: 'table',
          title: 'DB 4특징 한눈에',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '공용 데이터(Shared Data) — 여러 사용자가 [다른 목적] 으로 같은 데이터를 동시에 공유하며 사용한다는 특징이야. 부서/사용자마다 같은 데이터를 따로 보관하지 않고 한 곳에 두고 다 같이 보는 게 핵심.',
        },
        {
          kind: 'section',
          title: '대표 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '통합된 데이터(Integrated Data) — 같은 정보가 여러 곳에 흩어져 [중복 저장] 되지 않고 한 곳에 단일하게 보관돼. 중복이 없으면 갱신할 때도 한 번만 고치면 모든 부서가 자동으로 최신값을 봐.',
        },
        {
          kind: 'section',
          title: '대표 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '저장된 데이터(Stored Data) — 메모리 위의 임시 데이터가 아니라 [저장매체] (하드디스크·SSD·서버) 에 영속적으로 보관돼. 전원이 꺼져도 사라지지 않고, 필요할 때마다 다시 꺼내 볼 수 있는 게 핵심.',
        },
        {
          kind: 'section',
          title: '대표 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '변화하는 데이터(Operational/Changing Data) — 데이터에 새 행이 추가되고, 기존 값이 수정되며, 일부가 삭제되어도 DB 전체는 항상 [정확하고 일관된] 최신 상태를 유지해. 운영 중인 시스템에서 끊임없이 변화하는 게 본질.',
        },
        {
          kind: 'section',
          title: '대표 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Data Warehouse(DW) 는 다양한 운영 시스템의 데이터를 주제 지향적·시계열적으로 통합한, 의사결정 지원용 데이터의 집합이야. 운영 시스템(ERP·CRM·회계 등) 의 원시 데이터를 ETL 로 가공해 한 곳에 모아 BI·OLAP 분석에 쓰여.',
        },
        {
          kind: 'section',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'DW 의 핵심 목적은 [흩어진 데이터를 한 곳에 모아 쉽게 분석·결정] 할 수 있게 하는 거야. 부서마다, 시스템마다 따로 흩어진 데이터를 한 곳에서 정돈해서 같은 화면에서 전체 그림을 보게 만들어.',
        },
        {
          kind: 'section',
          title: '쉬운 비유 — 분식집 사장님',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'DW 의 [주요특징 4가지] — 주제 지향성·데이터 통합·시계열성·비휘발성. 이 4가지가 운영 DB(OLTP) 와 가장 크게 갈리는 지점이고, 시험에 단골로 매핑 문제로 등장해.',
        },
        {
          kind: 'table',
          title: '주요특징 한눈에',
        ...
        },
        {
          ...
          title: '★ 비휘발성 — 시험 1순위',
          body:
            '4가지 특징 중 [비휘발성] 이 시험에 가장 자주 등장. 한 번 들어온 데이터는 수정·삭제 없이 보존돼 (insert·read 만 가능). 운영계와의 가장 큰 차이.',
        },
      ],
    },
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Data Mart(DM) 는 특정 부서·주제에 특화된 [작은 규모] 의 데이터 저장소로, DW 의 부분집합이야. 큰 회사 전체의 통합 분석은 DW, 마케팅·재무·인사 같은 한 부서의 빠른 분석은 DM 이 담당.',
        },
        {
          kind: 'section',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'DM 의 핵심 목적은 [부서·주제 단위로 빠르게 분석] 할 수 있게 하는 거야. DW 의 거대한 창고에서 자기 부서 데이터를 찾는 것보다, 부서가 자기 데이터만 작게 가져 빠르게 결정하는 데 강점.',
        },
        {
          kind: 'section',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'DM 은 데이터를 어디에서 가져오느냐에 따라 [종속형(Dependent)] 과 [독립형(Independent)] 으로 나뉘어. 시험에 단골로 매핑 문제로 등장.',
        },
        {
          kind: 'table',
          title: '종속형 vs 독립형 비교',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Data Lake 는 정형뿐 아니라 반정형·비정형까지 형태 변환 없이 원시 상태로 적재하는 대규모 저장소야. 사진·영상·로그·SNS 글 같은 비정형도 다 받아.',
        },
        {
          kind: 'section',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Data Lake 의 핵심 목적은 [모든 형태 데이터를 원시로 일단 보존] 해 미래의 다양한 분석 가능성을 열어두는 거야. DW 처럼 분석 형태를 미리 정해 가공하는 게 아니라, 일단 받고 분석은 나중에.',
        },
        {
          kind: 'section',
          title: '활용 사례',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            '원시를 다 받아도 메타데이터·거버넌스 가 약하면 [Data Swamp] (데이터 늪) 가 돼. 누가 무슨 데이터를 언제 넣었는지 모르면 아무도 못 쓰는 쓰레기 더미. Lake 의 단골 함정.',
        },
      ],
    },
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'OLAP(Online Analytical Processing) 은 다차원 데이터를 빠르게 집계·조회할 수 있도록 설계된 분석 시스템이야. DW 와 짝꿍 — DW 가 데이터 창고라면 OLAP 은 그 창고를 다양한 각도로 보는 도구.',
        },
        {
          kind: 'section',
          title: '쉬운 비유 — 매출 보고서',
          body:
            '매장 매니저가 매출을 [지역 × 시기 × 상품] 같이 여러 축으로 동시에 본다고 상상해봐. "이번 달 강남점 떡볶이 매출", "지난 분기 전체 콜라 매출", "올해 모든 매장의 평균 객단가" — 같은 데이터를 다양한 시각으로 자르며 보는 것이 OLAP.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'OLAP 의 핵심 목적은 [다차원 데이터를 빠르게 집계·조회] 해 의사결정을 지원하는 거야. 시계열 비교, 부서·지역·상품 같은 주제별 시각화에 강점.',
        },
        {
          kind: 'section',
          title: '활용 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'OLTP(Online Transaction Processing) 은 실시간으로 들어오는 거래를 즉시 처리하는 운영 시스템이야. ms 단위 빠른 응답이 핵심. ERP·CRM·은행 거래·쇼핑몰 주문 같은 운영계 시스템이 모두 OLTP.',
        },
        {
          kind: 'section',
          title: '쉬운 비유 — 카페 POS',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'OLTP 의 핵심 목적은 [실시간 거래를 즉시 처리] 하면서 [데이터 일관성] 을 유지하는 거야. ms 단위 응답 + ACID 무결성 보장이 본질.',
        },
        {
          kind: 'section',
          title: '활용 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '회사가 커지면 부서마다 데이터가 따로 쌓이고, 같은 고객 정보가 영업·마케팅·CS 에 중복 저장돼. 이를 통합·표준화하기 위한 7가지 [기업 데이터베이스] 시스템이 시험 단골 — 인프라(DBMS) 위에 운영계(ERP·CRM·SCM) 가 올라가고, 그 위에서 지식·분석계(KMS·BI·BA) 가 의사결정으로 연결해.',
        },
        {
          kind: 'table',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'ERP(Enterprise Resource Planning) 는 생산·판매·재무·인사 등 전사적 자원을 하나의 시스템으로 통합해 부서 간 데이터 일관성을 확보해. 대표: SAP · Oracle ERP.',
        },
        {
          kind: 'section',
          title: '왜 ERP 가 필요한가',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'SCM(Supply Chain Management) 은 원자재 조달부터 생산·유통·반품까지 공급사슬 전체를 통합 관리해 재고·납기·비용을 최적화해. 협력사 정보 공유가 핵심.',
        },
        {
          kind: 'section',
          title: '왜 SCM 이 필요한가',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'KMS(Knowledge Management System) 는 조직의 지식·노하우·문서·매뉴얼을 체계적으로 축적·공유하는 시스템이야. SECI 모델 (암묵지 ↔ 형식지 4단계 변환) 을 시스템 형태로 구현한 것이 KMS — 직원 개인의 노하우를 조직 자산으로.',
        },
        {
          kind: 'section',
          title: '왜 KMS 가 필요한가',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'BI(Business Intelligence) 는 데이터를 다차원 분석·리포트·대시보드로 시각화해 경영 의사결정을 지원해. 대표: Tableau · Power BI · Looker.',
        },
        {
          kind: 'section',
          title: '왜 BI 가 필요한가',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'BA(Business Analytics) 는 BI 의 발전형으로, 통계·예측 모델·머신러닝까지 포함한 고급 분석 시스템이야. BI 가 "과거/현재 무슨 일이 일어났나" 라면, BA 는 "왜 일어났고, 앞으로 어떻게 될 것인지, 어떻게 대응할 것인지" 까지 답해.',
        },
        {
          kind: 'table',
          title: 'BI vs BA — 한눈에',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '빅데이터 시대는 어느 한 사건이 아니라 [5가지 기술 요인] 이 동시에 발달하면서 가능해졌어. 데이터를 [싸게 저장] 하고, [빠르게 처리] 하고, [멀리 전송] 하고, [어디서나 빌려쓰며], [모든 기기가 만들어내는] 환경이 만들어졌어.',
        },
        {
          kind: 'table',
          title: '빅데이터 출현 5요인',
        ...
        },
        {
          ...
          body:
            '시험에선 "다음 중 빅데이터 출현 배경이 아닌 것" 으로 자주 출제. 보기에 [표본 추출·정형화 기술] 같은 정반대 개념을 넣어 함정으로 만듦. 5가지 (저장·병렬·인터넷·클라우드·IoT) 만 외우면 돼.',
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          title: '데이터 단위 + "패지" 암기',
          body:
            'KB → MB → GB → TB → PB(페타) → EB(엑사) → ZB(제타) → YB(요타). 단계마다 1024배. PB 이상을 빅데이터 영역으로 봐. 앞 글자 P·E·Z·Y → "[패지]" 로 외우면 끝.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Volume(양) — 가장 직관적인 V 이야. 단위 시간·공간에 쌓인 데이터의 절대 규모가 너무 커서 평소 도구(엑셀·MySQL 단일 인스턴스) 로는 다룰 수 없는 상태. PB(페타바이트, 1024 TB) 이상이 되면 한 대 컴퓨터의 디스크·메모리·CPU 한계를 넘어가 분산처리가 필요해져.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
          body:
            '카카오톡 하루치 메시지 로그 / 유튜브 1분당 업로드되는 영상 500시간 / 글로벌 신용카드 회사의 1주일치 결제 트랜잭션. 이런 규모는 이미 "파일 한 개로 저장" 자체가 불가능해서, 수백~수천 대 서버에 쪼개 담는 분산저장(HDFS) 과 분산처리(Hadoop·Spark) 가 필수가 돼.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Variety(다양성) — 한 시스템 안에 정형(엑셀·DB 테이블) · 반정형(JSON·XML·로그) · 비정형(영상·이미지·음성·자유 텍스트) 이 함께 들어오는 상황이야. 단순히 양이 많은 게 아니라 형태가 제각각이라는 점이 핵심. 같은 양이라도 형태가 한 가지면 Variety 가 아니야.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Velocity(속도) — 데이터가 들어오고 처리되어야 하는 속도가 빠른 상황이야. 옛날 데이터 분석은 "저녁에 그날 매출을 한 번에 정리" 하는 배치(batch) 처리로 충분했지만, 빅데이터 시대엔 "지금 막 발생한 사건을 즉시 판단" 해야 하는 케이스가 많아졌어. 이걸 스트리밍(streaming) 처리라 불러.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '빅데이터 시대 이전엔 데이터가 비싸고 분석 도구도 비쌌어. 그래서 작은 표본을 정성스럽게 모으고, 데이터를 미리 정제하고, "왜 그런가" 의 인과를 밝히는 방식이 표준이었어. 지금은 저장·연산 비용이 폭락해 4가지 축에서 분석의 디폴트가 뒤집혔어.',
        },
        {
          kind: 'table',
        ...
        },
        {
          ...
          body:
            '예: "표본조사 → 전수조사" 는 규모 축, "인과관계 → 상관관계" 는 관점 축. 서로 다른 축의 변화를 섞어서 묻는 게 단골 함정. 어느 축의 변화인지 라벨을 먼저 붙여.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '[표본조사] 는 모집단(예: 전체 가입자) 의 일부만 추려 분석하는 것. [전수조사] 는 한 명도 빠짐없이 다 분석하는 것. 전통적 통계학은 비용 때문에 표본조사를 강제했지만, 빅데이터 시대엔 가입자 1억 명 거래 로그도 다 다룰 수 있게 됐어.',
        },
        {
          kind: 'section',
          title: '왜 가능해졌나 — 비용의 폭락',
          body:
            '저장 비용: 1990년대 1GB = 수백만 원 → 현재 = 수십 원. 연산 비용: 클라우드(AWS·GCP) 로 수천 대 컴퓨터를 분 단위로 빌릴 수 있게 됨. 이 두 변화로 "비용 때문에 표본만 보던" 제약이 사라졌어.',
        },
        {
          kind: 'section',
          title: '구체 사례',
          body:
            '예전: 백화점이 고객 1만 명 표본조사 → 만족도 설문 → 결과 일반화. 지금: 카드사 5천만 회원 전체의 1년치 거래 5억 건을 다 다루며 사기 탐지 모델 학습. 표본 추정의 오차 자체가 사라지고, 희소한 사례(예: 0.001% 의 사기 거래) 도 그대로 잡혀.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '[사전처리] 는 데이터 저장 전에 미리 정제·변환·정규화를 끝내는 방식 (DW 의 ETL · Schema-on-Write). [사후처리] 는 일단 원시(raw) 그대로 받아 두고 분석 시점에 비로소 가공하는 방식 (Data Lake 의 Schema-on-Read). 빅데이터 시대엔 다양한 형태의 데이터가 미리 정제하기 어려울 만큼 폭증해 사후처리가 표준이 됐어.',
        },
        {
          kind: 'section',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '[질] 이란 데이터가 얼마나 깔끔한지 — 결측·오타·이상치가 없는지를 말해. 전통 통계에선 작은 표본에서도 정확한 결론을 내야 했기에 데이터 정제에 큰 비중을 뒀어. 빅데이터에선 [양] 이 워낙 많아 일부 잡음이 평균에 묻혀버리는 효과가 생겨, 정제보다 양 확보가 우선이 됐어.',
        },
        {
          kind: 'section',
          title: '구체 사례',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '[인과관계](Causation) = "A 가 B 의 원인이다" — A 를 바꾸면 B 가 바뀐다는 직접적 영향 관계. [상관관계](Correlation) = "A 와 B 가 함께 변한다" — 둘이 동시 변하지만 무엇이 원인인지는 모름. 전통 과학은 인과관계를 증명해야 결론을 내렸지만, 빅데이터 시대엔 상관관계만으로도 마케팅·운영 결정엔 충분해.',
        },
        {
          kind: 'section',
          title: '구체 사례 — 상관만으로 충분한 경우',
          body:
            '월마트 분석: "허리케인 예보 직전 → 스트로베리 팝타르트 매출 7배 증가". 왜 사람들이 폭풍에 대비해 팝타르트를 사는지 인과관계는 모르지만, 매대를 미리 채워놓으면 매출이 올라. 상관관계만으로 의사결정 OK. / 넷플릭스 추천: "이 영화 본 사람은 저 영화도 본다" — 왜 그런 취향 패턴인지 몰라도 추천 효과는 충분.',
        },
        {
          kind: 'callout',
          tone: 'warn',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '빅데이터가 가진 여러 성격을 이해하기 위해 4가지 대표 비유가 사용돼. 각 비유는 빅데이터의 다른 면 (원동력 / 가공 / 관찰 / 토대) 을 강조해. 시험에선 "이 비유가 강조하는 것은?" 이나 "이 사례에 맞는 비유는?" 으로 자주 등장.',
        },
        {
          kind: 'table',
          title: '4가지 비유와 강조점',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '산업혁명 석탄·철 비유는 빅데이터를 [사회를 근본적으로 바꾸는 원동력] 으로 봐. 18세기 산업혁명이 석탄·철 같은 새로운 자원으로 인해 가능했듯이, 21세기 사회·경제 변혁의 핵심 자원이 빅데이터라는 시각.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '원유 비유는 빅데이터를 [정제해야 가치가 생기는 자원] 으로 봐. 원시 데이터(raw) 그대로는 쓸모가 없고, 분석·가공·정제 과정을 거쳐야 비로소 의사결정·서비스에 활용 가능. 데이터 사이언티스트의 역할이 정제소처럼 중요하다는 의미.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '렌즈 비유는 빅데이터를 [세상을 새롭게 관찰·발견하게 해주는 도구] 로 봐. 현미경이 미생물을, 망원경이 천체를 발견하게 해줬듯이, 빅데이터는 인간의 직관으로는 안 보이던 패턴·트렌드·연관성을 드러나게 해.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '플랫폼 비유는 빅데이터를 [다른 서비스가 그 위에서 자라는 토대] 로 봐. 빅데이터 자체보다는 그것을 활용해 만들어지는 AI·추천 시스템·자율주행 등의 응용 서비스가 만들어지는 기반. 생태계의 토대가 되는 자원이라는 시각.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '빅데이터는 강력한 만큼 [3가지 위기] 도 동반해. (1) 사생활 침해 — 데이터 수집·결합으로 개인 식별 위험. (2) 책임원칙 훼손 — 데이터 기반 자동 결정의 책임 모호. (3) 데이터 오용·과신 — 통계적 결론을 절대시 (Garbage In, Garbage Out). 각 위기마다 정해진 [대응책] 이 시험에 자주 매칭으로 등장.',
        },
        {
          kind: 'table',
          title: '3가지 위기 · 대응 짝',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터 사이언스는 "데이터에서 가치를 뽑는 종합 예술". 통계학이 엄밀한 수식 위에서 움직인다면, 데이터 사이언스는 여기에 컴퓨터공학(속도)과 비즈니스(목적) 가 합쳐진 훨씬 넓은 판이야. 한 사람이 셋을 다 갖추기는 어렵고 보통 팀으로 협업해.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
          title: '핵심 구성요소 — "AI 비"',
          body:
            'Analytics(분석) + IT(정보기술) + Business(비즈니스 컨설팅). 세 꼭짓점의 교집합에서 데이터 사이언스가 태어나.',
        },
        {
          kind: 'table',
      ...
      blocks: [
        {
          ...
          body:
            'Hard 는 "배워서 익히는 기술" — 머신러닝, SQL, 프로그래밍. Soft 는 "태도·관점·커뮤니케이션" — 통찰, 스토리텔링, 협력. 시험은 어떤 역량이 어느 쪽인지 매칭을 물어.',
        },
        {
          kind: 'table',
          headers: ['분류', '해당 역량'],
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '앞서 본 3축(Analytics·IT·Business) 을 더 잘게 쪼개 6가지 구체적 역량으로 표현한 것이 "Digital CA메라". 시험에선 6개 알파벳에 무엇이 매핑되는지·매핑 안 되는 단어가 무엇인지를 자주 물어 — Management 가 단골 함정.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Communication 은 분석 결과를 비즈니스 청중에 맞게 풀어내는 역량 — 시각화·스토리텔링·발표. 아무리 정확한 분석이라도 의사결정자에게 전달되지 않으면 가치가 없어.',
        },
        {
          kind: 'section',
          title: '시험 키워드',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Math 는 [통계·확률·선형대수·미적분] 등 분석의 수학적 기반. 모델 가정·수식 유도·검정의 토대. 자동차 엔진의 기름처럼 안 보이지만 모든 분석 활동이 그 위에서 돌아가.',
        },
        {
          kind: 'section',
          title: '시험 키워드',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Engineering 은 [데이터 파이프라인 · DB · 분산 처리 · 코드 구현] 능력. 모델을 실제 서비스로 옮기는 데 필수. 식당 주방처럼 좋은 도구·시스템이 있어야 요리(분석 결과) 가 손님(사용자) 에게 전달돼.',
        },
        {
          kind: 'section',
          title: '시험 키워드',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'Digital CAMERA 6역량 (Communication·Analytics·Math·Engineering·Research·Art) 에 [Management] 는 들어가지 않아. 답에 Management 가 보이면 즉시 오답 처리.',
        },
        {
          kind: 'section',
          title: '시험 키워드',
