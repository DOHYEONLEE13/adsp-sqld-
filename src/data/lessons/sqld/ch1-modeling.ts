  ...
  steps: [
    ...
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "식별자 관계와 비식별자 관계를 가르는 기준은 부모 식별자가 자식 엔터티의 PK에 포함되는지입니다. 자식의 PK 안에 들어가면 식별자 관계, PK 밖에서 FK로만 남으면 비식별자 관계입니다."
                },
                {
                      kind: "example",
                      title: "두 예시 비교",
                      body: "수강신청의 PK가 학번+과목코드라면 부모 키가 자식 PK 일부가 된 것입니다. 주문의 PK가 주문ID이고 고객ID는 FK로만 있다면 부모 키가 자식 PK에 들어가지 않은 것입니다."
                },
                {
                      kind: "table",
                      title: "관계 비교",
    ...
    },
    {
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "tip",
                      title: "한 줄 기준",
                      body: "후보키는 대표가 될 수 있는 후보, 기본키는 그중 실제 대표, 대체키는 대표가 되지 못한 후보, 슈퍼키는 불필요한 속성이 붙어도 한 행을 찾을 수 있는 넓은 키입니다."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "무결성은 데이터가 정확하고 일관된 상태를 유지하도록 DB가 지키는 규칙입니다. 입력, 수정, 삭제를 해도 약속한 규칙이 깨지면 안 됩니다."
                },
                {
                      kind: "example",
                      title: "학생 DB 예시",
                      body: "학번이 비어 있으면 학생 한 명을 구분할 수 없습니다. 수강 기록이 없는 학번을 가리키면 학생과 수강 기록의 연결이 깨집니다. 학년 칸에 99가 들어가도 현실과 맞지 않습니다."
                },
                {
                      kind: "keypoints",
                      title: "무결성은 무엇을 지킬까?",
    ...
    },
    {
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "tip",
                      title: "시험 감각",
                      body: "PK는 개체 무결성의 핵심입니다. UNIQUE는 중복을 막지만 대표 식별자라는 의미는 아닙니다. SQLD에서는 PK = UNIQUE + NOT NULL + 대표 키로 잡으면 안전합니다."
                }
          ]
    }
  ],
  ...
  steps: [
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "정규화는 한 테이블에 섞인 정보를 여러 테이블로 나누어 중복을 줄이고 이상 현상을 예방하는 과정입니다."
        },
        {
          kind: "keypoints",
          title: "왜 정규화할까?",
        ...
        },
        {
          ...
          tone: "mnemonic",
          title: "정규화 안의 이상 현상",
          body: "이상 현상은 독립된 주제가 아니라 정규화를 해야 하는 이유입니다. 삽입·삭제·갱신 이상은 바로 다음 카드에서 하나씩 봅니다."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "삽입 이상은 데이터를 삽입할 때 의도하지 않은 값까지 함께 삽입되거나, 필요한 다른 값이 없어 원하는 데이터를 넣지 못하는 현상입니다."
        },
        {
          kind: "example",
          title: "학생 과목 테이블 예시",
          body: "휴학생 105번을 등록하고 싶은데 과목명과 교수명 칸이 같은 표에 있어 NULL까지 넣어야 한다면 삽입 이상입니다."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "삭제 이상은 데이터를 삭제할 때 의도하지 않은 정보까지 함께 삭제되는 현상입니다."
        },
        {
          kind: "example",
          title: "학생 과목 테이블 예시",
          body: "학생 한 행을 지웠을 뿐인데 그 행에만 있던 과목명과 교수명 정보까지 사라지면 삭제 이상입니다."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "갱신 이상은 중복된 데이터 중 일부만 갱신되어 서로 맞지 않는 값이 남는 현상입니다."
        },
        {
          kind: "example",
          title: "학교 예시",
          body: "수학 담당 교수를 김OO에서 한OO로 바꿨는데 일부 행만 바뀌면 같은 수학 과목의 교수명이 두 개로 남습니다."
        }
      ]
    },
    {
