  ...
  steps: [
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터 모델링은 현실 세계의 정보를 [약속된 표기법]을 활용해 [DB]의 구조로 표현하는 과정이야. 본격적인 SQL을 짜기 전에, DB에 저장할 구조를 먼저 그려보는 단계야.',
        },
        {
          kind: 'example',
          title: '수강신청 예시',
          body:
            '학생은 과목을 신청하고, 개설된 과목에는 담당 교수와 시간이 정해져.\n\n이런 현실의 사실을 DB 구조로 바꾸는 첫 작업이 데이터 모델링이야.',
        },
        {
          kind: 'section',
          title: '한 문장으로 말하면',
          body:
            '데이터 모델링은 “현실을 표로 저장하기 전에, 무엇을 어떤 관계로 저장할지 약속된 그림으로 정리하는 일”야.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '좋은 데이터 모델은 복잡한 현실을 아무렇게나 표로 옮기지 않아. 쉽게 이해되고, 핵심만 남고, 누가 봐도 같은 뜻으로 읽혀야 해.',
        },
        {
          kind: 'keypoints',
        ...
        },
        {
          ...
          title: '"단·추·명"',
          body:
            '단순화·추상화·명확화. SQLD에서는 “좋은 모델이 갖춰야 할 특징”으로 묶어 기억하면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '단순화는 모델을 처음 보는 사람도 구조를 쉽게 이해할 수 있게 정리하는 특징이야. 복잡한 현실을 그대로 복사하는 것이 아니라, 읽기 쉬운 구조로 만드는 거야.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청을 한 줄짜리 거대한 표로 만들면 학생 정보, 과목 정보, 신청 기록이 뒤섞여. 반대로 학생·과목·수강신청처럼 역할을 나누면 처음 보는 사람도 구조를 따라가기 쉬워져.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '단순화의 기준',
          body:
            '처음 보는 사람이 “아, 이 구조구나!” 하고 따라올 수 있으면 단순화가 잘 된 모델이야.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '추상화는 현실의 모든 세부사항을 다 넣지 않고, 지금 만들려는 DB에 필요한 핵심만 남기는 특징이야.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청 DB를 만들 때 학생의 취미, 신발 사이즈, 점심 메뉴까지 모두 저장할 필요는 없어. 학생, 과목, 신청 기록처럼 수강신청에 필요한 핵심만 남기면 돼.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '추상화의 기준',
          body:
            '시험에서는 “핵심만 추출”, “필요한 정보만 남김” 같은 표현을 추상화로 연결하면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '명확화는 같은 모델을 본 사람들이 같은 의미로 이해하게 만드는 특징이야. 이름, 관계, 기준이 애매하면 좋은 모델이 아니야.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청 화면에 “날짜”라고만 적으면 신청한 날짜인지, 결제한 날짜인지, 수업 날짜인지 헷갈릴 수 있어. “수강신청일”처럼 의미가 분명해야 해.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '명확화의 기준',
          body:
            '누가 봐도 같은 뜻으로 읽히면 명확화가 잘 된 모델이야. 반대로 사람마다 다르게 해석되면 명확화가 부족해.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '모델링은 데이터만 보는 작업이 아니야. 무엇을 저장하는지, 업무가 어떻게 흐르는지, 업무가 데이터를 어디서 쓰는지를 함께 봐.',
        },
        {
          kind: 'keypoints',
        ...
        },
        {
          ...
          title: '"데·프·상"',
          body:
            '데이터·프로세스·상관. 특히 상관 관점은 “업무와 데이터가 만나는 지점”이라고 생각하면 덜 딱딱해.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터 관점은 업무에서 어떤 데이터를 저장해야 하는지 보는 관점이야. 나중에 [엔터티], [속성], [식별자]를 찾는 출발점이 돼.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청을 만든다면 “학생”, “과목”, “수강신청 기록”처럼 저장해야 할 대상을 먼저 찾아. 이것이 데이터 관점이야.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '데이터 관점의 기준',
          body:
            '문제에서 “무엇을 저장하는가”, “엔터티와 속성”이 보이면 데이터 관점을 떠올리면 돼. 정확한 용어 정의는 곧 이어지는 스텝에서 다시 다뤄.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '프로세스 관점은 업무가 어떤 단계로 진행되는지 보는 관점이야. 데이터 자체보다 업무의 흐름과 절차에 초점을 둬.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청 업무라면 “강의 조회 → 과목 선택 → 신청 완료”처럼 업무가 어떤 순서로 진행되는지 정리해.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '프로세스 관점의 기준',
          body:
            '문제에서 “업무 흐름”, “절차”, “어떤 순서로 처리되는가”가 보이면 프로세스 관점을 떠올리면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '상관 관점은 프로세스와 데이터가 만나는 지점을 보는 관점이야. 업무가 어떤 데이터를 만들고, 읽고, 수정하고, 삭제하는지 확인해. 이 네 가지 행동을 줄여 [CRUD]라고 불러.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청 버튼을 누르면 학생 정보를 읽고, 수강신청 기록을 새로 만들어. 이런 연결을 보는 것이 상관 관점이야.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
          title: 'CRUD',
          body:
            'Create(만들기) · Read(읽기) · Update(고치기) · Delete(지우기). 업무가 데이터에 하는 기본 동작 4가지야.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터 모델링은 보통 개념적 → 논리적 → 물리적 순서로 진행해. 처음에는 큰 그림을 그리고, 그다음 구조를 정리하고, 마지막에 실제 DB에 맞게 바꿔.',
        },
        {
          kind: 'keypoints',
          title: '3단계 — "개논물"',
        ...
        },
        {
          ...
          title: '"개논물"',
          body:
            '개념(스케치) → 논리(설계도) → 물리(시공). 시험에서는 순서와 단계별 특징 매칭이 자주 나와.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '개념적 모델링은 업무의 큰 그림을 잡는 단계야. 어떤 대상이 있고, 서로 어떻게 연결되는지 먼저 봐.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '수강신청 시스템이라면 “학생이 과목을 신청한다”는 큰 관계를 먼저 잡아. 컬럼 자료형이나 인덱스는 아직 정하지 않아.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '개념적 단계의 기준',
          body:
            '문제에서 “업무 관점”, “큰 그림”, “핵심 대상과 관계”가 보이면 개념적 모델링을 떠올리면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '논리적 모델링은 개념적 모델을 더 정밀한 DB 구조로 정리하는 단계야. 키, 관계, 중복 제거, 함수적 종속 같은 논리 구조를 다뤄.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '학생은 학번으로 구분하고, 학번을 알면 이름이 정해진다는 의존성도 확인해. 수강신청 기록은 학생과 과목을 연결한다고 정리해. 아직 Oracle인지 MySQL인지는 핵심이 아니야.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '논리적 단계의 기준',
          body:
            '시험에서 “정규화”, “키”, “관계 정밀화”, “재사용성”이 보이면 논리적 모델링에 가까워.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '물리적 모델링은 논리 구조를 실제 DBMS에 맞게 구현하는 단계야. 자료형, 인덱스, 저장 방식, 성능을 고려해.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '학번을 문자로 저장할지 숫자로 저장할지, 자주 검색하는 컬럼에 인덱스를 둘지, Oracle과 MySQL 중 어디에 맞출지 결정해.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '물리적 단계의 기준',
          body:
            '문제에서 “자료형”, “인덱스”, “저장 공간”, “성능”, “DBMS 종속”이 보이면 물리적 모델링을 떠올리면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'ANSI/SPARC 3-스키마는 DB를 외부 스키마, 개념 스키마, 내부 스키마로 나누어 보는 구조야.',
        },
        {
          kind: 'keypoints',
          title: '3계층 — "외개내"',
        ...
        },
        {
          ...
          title: '"외·개·내"',
          body:
            '외부(사용자) → 개념(전체) → 내부(저장). “조직 전체 통합” 키워드가 보이면 개념 스키마야.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '외부 스키마는 사용자나 응용 프로그램이 보는 DB의 모습이야. 사용자별 화면 또는 뷰라고 생각하면 쉬워.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '같은 학교 DB라도 학생은 내 수강 내역을 보고, 교수는 담당 강의 수강생 명단을 봐. 이렇게 사용자별로 보이는 구조가 외부 스키마야.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '외부 스키마의 기준',
          body:
            '문제에서 “사용자별”, “응용 프로그램별”, “개별 화면”, “여러 개”가 보이면 외부 스키마를 떠올리면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '개념 스키마는 조직 전체의 DB 구조를 통합해서 표현한 거야. 외부 스키마처럼 사용자별로 여러 개가 아니라 전체 관점이야.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '개념 스키마의 기준',
          body:
            '문제에서 “조직 전체”, “통합”, “전체 DB 구조”, “하나의 전체 관점”이 보이면 개념 스키마야.',
        },
        {
          kind: 'callout',
          tone: 'warn',
          title: '함정 보기',
          body:
            '“응용 스키마”, “논리 스키마”, “외래 스키마” 같은 보기는 ANSI/SPARC 3-스키마의 정식 이름이 아니야.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '내부 스키마는 데이터가 실제 저장장치에 어떻게 저장되는지 다루는 구조야. 물리 저장 구조에 가까워.',
        },
        {
          kind: 'example',
          title: '쉬운 예시',
          body:
            '학생 정보가 어떤 파일 구조로 저장되는지, 인덱스를 어떻게 둘지, 저장 공간을 어떻게 배치할지 같은 내용이 내부 스키마와 가까워.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '내부 스키마의 기준',
          body:
            '문제에서 “물리 저장”, “저장장치”, “파일 구조”, “인덱스”가 보이면 내부 스키마를 떠올리면 돼.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '데이터 독립성은 한 계층의 변경이 다른 계층에 미치는 영향을 줄이는 성질이야. 3-스키마 구조를 나누는 핵심 이유야.',
        },
        {
          kind: 'keypoints',
          title: '독립성 2종',
        ...
        },
        {
          ...
          title: '논리적 독립성 예시',
          body:
            '학교 DB에 “장학금” 정보를 새로 관리하기로 했다고 해봅시다. DB 전체 구조에는 장학금 관련 정보가 추가되지만, 학생이 보는 “내 성적 보기” 화면이 그대로라면 논리적 독립성에 가까워.',
        },
        {
          kind: 'example',
          title: '물리적 독립성 예시',
          body:
            '학교가 성적 데이터를 더 빠른 저장공간으로 옮겼다고 해봅시다. 그래도 학생은 같은 “내 성적 보기” 화면을 보고, DB 전체 구조 설명도 그대로라면 물리적 독립성에 가까워.',
        },
        {
          kind: 'callout',
          tone: 'tip',
          title: '구분 기준',
          body:
            '관리하는 데이터의 구조가 바뀌면 논리적 독립성, 저장하거나 찾는 방법이 바뀌면 물리적 독립성을 떠올리면 돼.',
        },
      ],
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "엔터티는 업무에서 관리해야 하는 대상이야. 사람, 물건, 장소뿐 아니라 주문·수강신청처럼 발생한 사건도 엔터티가 될 수 있어."
                },
                {
                      kind: "example",
                      title: "수강신청 예시",
                      body: "학생 정보는 학생 엔터티, 과목 정보는 과목 엔터티, 누가 어떤 과목을 신청했는지는 수강신청 엔터티로 나눠 관리할 수 있어."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "처음엔 이렇게 기억",
                      body: "엔터티 = DB에서 표로 만들 후보. “이걸 따로 관리해야 하나?”라고 물어보면 돼."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "엔터티는 현실의 대상을 DB에서 따로 관리하기 위해 만든 표의 후보야. 그래서 “업무에 필요한가?”, “각각을 구분할 수 있는가?”, “실제 예시가 여러 개 있는가?”, “설명할 속성이 있는가?”, “다른 대상과 연결되는가?”를 차례대로 확인해."
                },
                {
                      kind: "keypoints",
                      title: "엔터티 5요건",
                ...
                },
                {
                      ...
                      tone: "warn",
                      title: "시험 함정",
                      body: "“반드시 영속적으로 저장되어야 한다”는 엔터티 요건이 아니야. 한 학기만 쓰는 임시 관리 대상도 엔터티가 될 수 있어."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "좋은 엔터티 이름은 현업에서 쓰는 말과 가까워야 해. 줄임말이나 애매한 이름은 나중에 모델을 읽는 사람을 헷갈리게 해."
                },
                {
                      kind: "keypoints",
                      title: "명명 규칙",
                ...
                },
                {
                      kind: "example",
                      title: "쉬운 예시",
                      body: "“학생들”, “STU”, “사용자정보1”보다 “학생”이 더 좋은 이름이야."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "유무형 분류는 엔터티가 어떤 성격의 대상인지 보는 기준이야."
                },
                {
                      kind: "table",
                      title: "유무형 분류",
                ...
                },
                {
                      ...
                      tone: "mnemonic",
                      title: "개·사·유",
                      body: "개념·사건·유형을 묶어 외우면 보기를 빠르게 지울 수 있어."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "발생 시점 분류는 엔터티가 업무 흐름에서 어떤 순서와 역할로 생기는지 보는 기준이야."
                },
                {
                      kind: "table",
                      title: "발생 시점 분류",
                ...
                },
                {
                      ...
                      tone: "warn",
                      title: "가짜 보기 주의",
                      body: "발생 시점 분류는 기본·중심·행위야. “관계 엔터티”는 이 분류명이 아니야."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "엔터티 분류 문제는 기준을 섞어 내는 경우가 많아. 보기 자체보다 “유무형을 묻는지, 발생 시점을 묻는지”를 먼저 확인해."
                },
                {
                      kind: "keypoints",
                      title: "구분법",
    ...
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "속성은 엔터티를 설명하는 최소 데이터 단위야. 학생이라는 대상을 관리하려면 학번·이름·학과처럼 더 이상 나누지 않고 하나의 의미로 쓰는 항목들이 필요해."
                },
                {
                      kind: "example",
                      title: "표로 보면",
                      body: "학생 테이블의 컬럼이 학번, 이름, 학과라면 각각이 속성이야."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "원자성",
                      body: "한 속성에는 하나의 의미만 담는 것이 좋아. 주소 전체를 한 칸에 모두 넣기보다 우편번호, 시도, 도로명처럼 필요한 단위로 나누면 검색과 수정이 쉬워져."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "기본 속성은 업무에 원래 존재하는 속성이야. 시스템을 만들기 전에도 학생에게 이름과 생년월일이 있듯이, 현실 업무에서 자연스럽게 필요한 값이야."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "쉽게 구분하기",
                      body: "시스템이 새로 만든 값인지, 다른 값으로 계산한 값인지 고민하기 전에 “현실 업무에 원래 있던 값인가?”를 먼저 봐."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "설계 속성은 데이터 모델을 설계하는 과정에서 새로 만든 속성이야. 업무를 더 쉽게 식별하거나 관리하기 위해 시스템이 부여하는 값이 많아."
                },
                {
                      kind: "example",
                      title: "쉬운 예시",
                      body: "쇼핑몰에서 주문을 구분하려고 만든 주문번호, 회원을 구분하려고 만든 회원ID는 설계 속성으로 볼 수 있어."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "파생 속성은 다른 속성으로부터 계산되거나 가공되어 만들어지는 속성이야. 시험에서도 자주 묻는 중요한 개념이야."
                },
                {
                      kind: "callout",
                      tone: "warn",
                      title: "파생 속성이 중요한 이유",
                      body: "파생 속성은 편하지만 원본 값이 바뀌면 함께 다시 계산해야 해. 그래서 저장할지, 필요할 때 계산할지 모델링 단계에서 신중히 판단해야 해."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "단일 속성은 하나의 의미로 쓰는 속성이야. 학번, 이름처럼 더 쪼개서 관리할 필요가 없는 값을 떠올리면 쉬워."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "원자성과 연결",
                      body: "단일 속성은 앞에서 배운 원자성과도 연결돼. 한 칸에는 하나의 의미만 담는다는 감각을 유지하면 돼."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "복합 속성은 하나처럼 보이지만 내부를 나눠 볼 수 있는 속성이야. 주소는 시, 구, 도로명, 상세주소처럼 하위 속성으로 나눌 수 있어."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "모델링 감각",
                      body: "항상 쪼개야 한다는 뜻은 아니야. 검색, 정렬, 검증에 따로 필요하면 나눠서 관리하는 쪽을 생각해."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "다중값 속성은 한 인스턴스가 같은 속성 값을 여러 개 가질 수 있는 경우야. 전화번호 여러 개, 이메일 여러 개처럼 반복되는 값을 떠올리면 쉬워."
                },
                {
                      kind: "callout",
                      tone: "warn",
                      title: "시험 포인트",
                      body: "다중값 속성을 한 테이블 안에 반복 컬럼으로 계속 두면 관리가 어려워져. 보통 별도 엔터티나 테이블로 분리하는 방향을 생각해."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "PK 속성은 테이블에서 한 행을 유일하게 구분하는 대표 속성이야. 학생 표의 학번처럼 중복되면 안 되는 값을 떠올리면 쉬워."
                },
                {
                      kind: "callout",
                      tone: "warn",
                      title: "PK 핵심",
                      body: "PK는 비어 있으면 안 되고, 같은 값이 두 번 나오면 안 돼. 그래서 한 데이터를 정확히 찾을 때 기준점이 돼."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "FK 속성은 다른 테이블의 대표값을 참조해 두 테이블을 연결해. 학생의 학과ID가 학과 테이블의 학과ID를 가리키는 식이야."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "쉽게 보기",
                      body: "PK가 '내 표 안에서 나를 찾는 값'이라면, FK는 '다른 표의 누구와 연결되는지 알려주는 값'이야."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "일반 속성은 PK나 FK처럼 특별한 연결 역할을 하지는 않지만, 인스턴스를 설명하는 데 필요한 속성이야."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "도메인",
                      body: "도메인은 속성이 가질 수 있는 값의 범위야. 예: 학년은 1~4 중 하나, 성별은 정해진 코드 중 하나."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "관계는 둘 이상의 엔터티가 업무적으로 어떻게 연결되는지를 표현해."
                },
                {
                      kind: "example",
                      title: "수강신청 예시",
                      body: "학생은 과목을 수강하고, 고객은 상품을 주문하고, 직원은 부서에 소속돼. 이런 동사형 연결이 관계야."
                }
          ]
    },
    {
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "mnemonic",
                      title: "관·차·선",
                      body: "관계명, 차수, 선택사양. 관계 문제는 이 세 단어를 먼저 떠올리면 돼."
                }
          ]
    },
    {
          ...
          blocks: [
                ...
                },
                {
                      kind: "example",
                      title: "선택사양 예시",
                      body: "모든 학생이 반드시 학과에 소속되어야 한다면 필수. 아직 학과가 정해지지 않은 학생도 허용한다면 선택이야."
                }
          ]
    },
    {
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "mnemonic",
                      title: "도배설명차선",
                      body: "도출, 배치, 설정, 명명, 차수, 선택사양의 앞글자를 이어 붙인 암기어야. 실제 개념은 순서와 각 단계의 의미야."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "M:N 관계는 중간에 교차 엔터티를 넣어 두 개의 1:M 관계로 바꿔."
                },
                {
                      kind: "example",
                      title: "쉬운 예시",
                      body: "학생은 여러 과목을 듣고, 과목도 여러 학생이 들어. 그래서 “수강신청” 엔터티를 넣어 학생-수강신청-과목으로 풀어내."
                },
                {
                      kind: "callout",
                      tone: "tip",
                      title: "왜 필요할까",
                      body: "교차 엔터티에는 신청일, 성적, 상태처럼 관계 자체의 속성을 담을 수 있어."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "식별자는 엔터티 안의 각 인스턴스를 서로 구분할 수 있게 해주는 속성 또는 속성 묶음이야."
                },
                {
                      kind: "example",
                      title: "학생 예시",
                      body: "학번이 20260001이면 특정 학생 한 명을 가리킬 수 있어. 그래서 학번은 학생 엔터티의 식별자가 될 수 있어."
                }
          ]
    },
    {
    ...
    },
    {
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "mnemonic",
                      title: "유최불존",
                      body: "유일성, 최소성, 불변성, 존재성. “의미성”은 4요건이 아니야."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "식별자 관계에서는 부모 엔터티의 주식별자가 자식 엔터티의 주식별자에 포함돼. 자식은 부모 키를 빌려 자기 PK를 완성해."
                },
                {
                      kind: "example",
                      title: "수강신청 예시",
                      body: "수강신청이 (학번, 과목코드)로 식별된다면 학생의 학번과 과목의 과목코드가 자식 엔터티인 수강신청의 PK 일부가 돼."
                },
                {
                      kind: "callout",
                      tone: "warn",
                      title: "시험 포인트",
                      body: "부모 PK가 자식 PK에 포함되면 식별자 관계야. 이때 부모 키는 자식 PK의 일부라서 NULL이면 안 돼."
                }
          ]
    },
    {
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "비식별자 관계에서는 부모의 식별자가 자식의 주식별자에 포함되지 않고, 일반 속성 또는 외래키로만 존재해."
                },
                {
                      kind: "example",
                      title: "주문 예시",
                      body: "주문ID가 주문의 PK이고 고객ID는 FK라면, 주문은 고객을 참조하지만 주문ID만으로도 주문을 구분할 수 있어."
                },
                {
                      kind: "callout",
                      tone: "warn",
                      title: "함정",
                      body: "비식별자 관계는 부모 키가 자식 PK에 포함되지 않는다는 뜻이야. 관계가 필수인지 선택인지는 업무 규칙에 따라 별도로 판단해."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "이제 식별자 관계와 비식별자 관계를 한 번에 비교해보자."
                },
                {
                      pose: "lightbulb",
                      text: "기준은 하나야.\n부모 키가 자식의 [대표 이름표(PK)] 안에 들어갔는지 보면 돼."
                },
                {
                      pose: "happy",
                      text: "수강신청이 학번+과목코드로 구분되면 부모 키가 자식 PK 안에 들어간 거야."
                },
                {
                      pose: "think",
                      text: "반대로 주문이 주문ID로만 구분되고 고객ID는 FK로만 있으면 PK 밖에 있는 거야."
                },
                {
                      pose: "lightbulb",
                      text: "PK 안이면 식별자 관계.\nPK 밖에서 FK로만 연결되면 비식별자 관계."
                },
                {
                      pose: "happy",
                      text: "IE 표기에서는 식별자 관계는 보통 실선, 비식별자 관계는 점선으로 그려."
                },
                {
                      pose: "idle",
                      text: "두 관계를 구분하는 기준을 확인해보자."
                }
          ],
          blocks: [
                {
                      kind: "intro",
                      body: "식별자 관계와 비식별자 관계를 가르는 기준은 부모 식별자가 자식 엔터티의 PK에 포함되는지야. 자식의 PK 안에 들어가면 식별자 관계, PK 밖에서 FK로만 남으면 비식별자 관계야."
                },
                {
                      kind: "example",
                      title: "두 예시 비교",
                      body: "수강신청의 PK가 학번+과목코드라면 부모 키가 자식 PK 일부가 된 거야. 주문의 PK가 주문ID이고 고객ID는 FK로만 있다면 부모 키가 자식 PK에 들어가지 않은 거야."
                },
                {
                      kind: "table",
                      title: "관계 비교",
                ...
                },
                {
                      ...
                      tone: "warn",
                      title: "함정",
                      body: "식별자 관계라고 해서 항상 1:1만 되는 것은 아니야. 1:M도 가능해."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "wave",
                      text: "[키]는 표에서 원하는 한 행을 찾거나, 다른 표와 연결할 때 쓰는 기준값이야."
                },
                {
                      pose: "think",
                      text: "처음엔 5개가 많아 보이지만, 질문은 세 가지야.\n유일한가? 대표로 골랐나? 다른 표와 연결하나?"
                },
                {
                      pose: "lightbulb",
                      text: "[슈퍼키]는 한 행을 찾을 수 있는 넓은 후보야.\n그중 불필요한 속성을 뺀 최소 후보가 [후보키]야."
                },
                {
                      pose: "happy",
                      text: "[기본키]는 후보키 중 대표로 고른 키.\n[대체키]는 대표로 뽑히지 않은 나머지 후보키야."
                },
                {
                      pose: "lightbulb",
                      text: "[외래키]는 다른 표의 대표값을 가져와 두 표를 연결하는 키야."
                },
                {
                      pose: "idle",
                      text: "키의 종류를 확인해보자."
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "tip",
                      title: "한 줄 기준",
                      body: "후보키는 대표가 될 수 있는 후보, 기본키는 그중 실제 대표, 대체키는 대표가 되지 못한 후보, 슈퍼키는 불필요한 속성이 붙어도 한 행을 찾을 수 있는 넓은 키야."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "[무결성]은 데이터가 DB 안에서 약속한 규칙을 계속 지키는 상태야."
                },
                {
                      pose: "lightbulb",
                      text: "학생 표를 떠올려보자.\n학번이 비거나 중복되면 한 학생을 정확히 찾을 수 없겠지?"
                },
                {
                      pose: "happy",
                      text: "수강 표의 학번이 학생 표에 실제로 없다면, 존재하지 않는 학생의 수강 기록이 생겨."
                },
                {
                      pose: "lightbulb",
                      text: "[개체 무결성]은 PK 규칙,\n[참조 무결성]은 FK 연결 규칙,\n[도메인 무결성]은 값 범위 규칙이야."
          ...
          blocks: [
                {
                      kind: "intro",
                      body: "무결성은 데이터가 정확하고 일관된 상태를 유지하도록 DB가 지키는 규칙이야. 입력, 수정, 삭제를 해도 약속한 규칙이 깨지면 안 돼."
                },
                {
                      kind: "example",
                      title: "학생 DB 예시",
                      body: "학번이 비어 있으면 학생 한 명을 구분할 수 없어. 수강 기록이 없는 학번을 가리키면 학생과 수강 기록의 연결이 깨져. 학년 칸에 99가 들어가도 현실과 맞지 않아."
                },
                {
                      kind: "keypoints",
                      title: "무결성은 무엇을 지킬까?",
                ...
                },
                {
                      ...
                      tone: "mnemonic",
                      title: "PK · FK · 값 범위",
                      body: "문제에서 PK가 나오면 개체 무결성, FK가 나오면 참조 무결성, 값의 범위나 형식이 나오면 도메인 무결성을 떠올리면 돼."
                }
          ]
    },
    {
          ...
          dialogue: [
                {
                      pose: "think",
                      text: "[PK]와 [UNIQUE]는 둘 다 중복을 막지만 목적이 달라."
                },
                {
                      pose: "lightbulb",
                      text: "[PK]는 테이블의 대표 이름표야.\n그래서 중복도 안 되고, [NULL]도 안 돼."
                },
                {
                      pose: "happy",
                      text: "[UNIQUE]는 대표 이름표가 아니라 중복 방지 잠금이야.\nSQLD/Oracle 기준으로 NULL은 허용될 수 있어."
                },
                {
                      pose: "lightbulb",
                      text: "예를 들어 id는 PK로 쓰고, 이메일은 UNIQUE로 중복만 막을 수 있어."
                },
                {
                      pose: "happy",
                      text: "테이블에는 PK 제약은 하나만 두고, UNIQUE 제약은 여러 개 둘 수 있어."
                },
                {
                      pose: "idle",
          ...
          blocks: [
                ...
                },
                {
                      ...
                      tone: "tip",
                      title: "시험 감각",
                      body: "PK는 개체 무결성의 핵심이야. UNIQUE는 중복을 막지만 대표 식별자라는 의미는 아니야. SQLD에서는 PK = UNIQUE + NOT NULL + 대표 키로 잡으면 안전해."
                }
          ]
    }
  ],
  ...
  steps: [
    {
      ...
      dialogue: [
        {
          pose: "wave",
          text: "Part 2는 [정규화]에서 시작하는 게 자연스러워."
        },
        {
          pose: "think",
          text: "[정규화]는 한 표에 섞인 정보를 성격별로 나누어 중복을 줄이는 과정이야."
        },
        {
          pose: "lightbulb",
          text: "예를 들어 학생, 과목, 교수 정보를 한 표에 몰아넣으면 같은 과목명과 교수명이 계속 반복돼."
        },
        {
          pose: "happy",
        ...
        {
          pose: "idle",
          text: "즉, 이상 현상은 정규화를 배우는 이유야.\n먼저 이 큰 흐름부터 확인해보자."
        }
      ],
      blocks: [
        {
          kind: "intro",
          body: "정규화는 한 테이블에 섞인 정보를 여러 테이블로 나누어 중복을 줄이고 이상 현상을 예방하는 과정이야."
        },
        {
          kind: "keypoints",
          title: "왜 정규화할까?",
          items: [
            "학생, 수강, 과목처럼 성격이 다른 정보를 한 표에 섞으면 중복이 생김",
            "중복이 많으면 삽입·삭제·갱신할 때 이상 현상이 생김",
            "정규화는 섞인 정보를 나누어 중복과 이상 현상을 줄임"
          ]
        },
        {
          kind: "callout",
          tone: "mnemonic",
          title: "정규화 안의 이상 현상",
          body: "이상 현상은 독립된 주제가 아니라 정규화를 해야 하는 이유야. 삽입·삭제·갱신 이상은 바로 다음 카드에서 하나씩 봐."
        }
      ]
    },
    {
      ...
      dialogue: [
        {
          pose: "think",
          text: "[삽입 이상]은 데이터를 삽입할 때 의도하지 않은 값까지 함께 삽입되는 현상이야."
        },
        {
          pose: "lightbulb",
          text: "예를 들어 휴학생 한 명만 등록하고 싶은데, 과목명과 교수명 칸까지 NULL로 같이 넣어야 한다면 이상하지?"
        },
        {
          pose: "happy",
          text: "삽입하려던 건 학생 정보인데, 의도하지 않은 과목·교수 값까지 따라 들어오는 거야."
        },
        {
          pose: "idle",
          text: "삽입 이상 예시를 골라보자."
      ...
      blocks: [
        {
          kind: "intro",
          body: "삽입 이상은 데이터를 삽입할 때 의도하지 않은 값까지 함께 삽입되거나, 필요한 다른 값이 없어 원하는 데이터를 넣지 못하는 현상이야."
        },
        {
          kind: "example",
          title: "학생 과목 테이블 예시",
          body: "휴학생 105번을 등록하고 싶은데 과목명과 교수명 칸이 같은 표에 있어 NULL까지 넣어야 한다면 삽입 이상이야."
        }
      ]
    },
    {
      ...
      dialogue: [
        {
          pose: "think",
          text: "[삭제 이상]은 데이터를 삭제할 때 의도하지 않은 정보까지 함께 삭제되는 현상이야."
        },
        {
          pose: "lightbulb",
          text: "장보고 학생 행을 지웠더니 경제 과목과 박OO 교수 정보까지 같이 사라지는 장면을 떠올려봐."
        },
        {
          pose: "idle",
      ...
      blocks: [
        {
          kind: "intro",
          body: "삭제 이상은 데이터를 삭제할 때 의도하지 않은 정보까지 함께 삭제되는 현상이야."
        },
        {
          kind: "example",
          title: "학생 과목 테이블 예시",
          body: "학생 한 행을 지웠을 뿐인데 그 행에만 있던 과목명과 교수명 정보까지 사라지면 삭제 이상이야."
        }
      ]
    },
    {
      ...
      dialogue: [
        {
          pose: "think",
          text: "[갱신 이상]은 일부 데이터만 갱신되어 모순이 발생하는 현상이야."
        },
        {
          pose: "lightbulb",
          text: "수학 교수명이 여러 행에 반복되어 있으면 교수명을 바꿀 때 관련 행을 전부 고쳐야 해."
        },
        {
          pose: "happy",
          text: "한 행이라도 놓치면 같은 수학 과목인데 교수명이 서로 다르게 남아 모순이 생겨."
        },
        {
          pose: "idle",
          text: "갱신 이상 상황을 골라보자."
      ...
      blocks: [
        {
          kind: "intro",
          body: "갱신 이상은 중복된 데이터 중 일부만 갱신되어 서로 맞지 않는 값이 남는 현상이야."
        },
        {
          kind: "example",
          title: "학교 예시",
          body: "수학 담당 교수를 김OO에서 한OO로 바꿨는데 일부 행만 바뀌면 같은 수학 과목의 교수명이 두 개로 남아."
        }
      ]
    },
    {
      ...
      dialogue: [
        ...
        {
          pose: "happy",
          text: "이 관계를 알아야 어떤 값을 다른 테이블로 분리할지 판단할 수 있어. 정규화의 근거가 되는 개념이야."
        },
        {
          pose: "idle",
      ...
      blocks: [
        {
          kind: "intro",
          body: "함수적 종속은 어떤 속성 값이 정해지면 다른 속성 값이 하나로 정해지는 관계야."
        },
        {
          kind: "table",
          title: "읽는 법",
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "완전 함수 종속은 복합키 전체에 종속되는 상태야."
        },
        {
          kind: "example",
          title: "성적 예시",
          body: "수강성적 테이블의 PK가 학번+과목코드일 때, 성적은 두 값을 모두 알아야 결정돼."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "부분 함수 종속은 복합키 전체가 아니라 일부 키에만 매달린 속성이 있는 상태야."
        },
        {
          kind: "callout",
          tone: "tip",
          title: "2NF와 연결",
          body: "부분 함수 종속을 제거하는 단계가 제2정규형(2NF)야."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "이행 함수 종속은 중간 속성을 한 번 거쳐서 결정되는 종속이야."
        },
        {
          kind: "example",
          title: "학교 예시",
          body: "학번을 알면 학과코드를 알고, 학과코드를 알면 학과명을 알 수 있어. 이때 학과명은 학번에 간접으로 종속돼."
        },
        {
          kind: "callout",
          tone: "tip",
          title: "3NF와 연결",
          body: "이행 함수 종속을 제거하는 단계가 제3정규형(3NF)야."
        }
      ]
    },
    {
      ...
      dialogue: [
        ...
        {
          pose: "think",
          text: "앞에서 본 이상 현상과 함수적 종속을 줄이기 위해 정해둔 정리 순서라고 보면 돼."
        },
        {
          pose: "think",
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "제1정규형은 속성 값이 원자값이어야 한다는 조건이야."
        },
        {
          kind: "example",
          title: "나쁜 예시",
          body: "전화번호 컬럼 하나에 집전화와 휴대폰을 함께 적으면 검색과 수정이 어려워져."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "제2정규형은 부분 함수 종속을 제거한 상태야."
        },
        {
          kind: "callout",
          tone: "warn",
          title: "등장 조건",
          body: "2NF 문제는 주로 복합키가 있는 테이블에서 나와. 단일키만 있으면 부분 종속을 묻기 어려워."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "제3정규형은 이행 함수 종속을 제거한 상태야."
        },
        {
          kind: "example",
          title: "분리 감각",
          body: "학생(학번, 이름, 학과코드) / 학과(학과코드, 학과명)처럼 나누면 학과명이 여러 번 반복되지 않아."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "반정규화는 정규화된 테이블을 일부러 합치거나 값을 중복시켜 조회 성능을 높이는 방법이야."
        },
        {
          kind: "callout",
          tone: "warn",
          title: "먼저 측정",
          body: "반정규화는 성능 문제가 확인된 뒤 적용하는 최적화야. 무작정 중복시키면 관리 부담만 커질 수 있어."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      dialogue: [
        {
          pose: "wave",
          text: "이제 성능 이야기를 잠깐 내려놓고, 모델 구조에서 자주 나오는 특수한 관계를 볼 거야."
        },
        {
          pose: "think",
      ...
      blocks: [
        {
          kind: "intro",
          body: "특수 관계는 일반적인 1:M 관계보다 구조를 한 번 더 생각해야 하는 관계 패턴이야."
        },
        {
          kind: "table",
          title: "대표 패턴",
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "계층형 또는 순환 관계는 같은 엔터티 안에서 부모-자식처럼 연결되는 구조야."
        },
        {
          kind: "example",
          title: "사원 예시",
          body: "사원 테이블에 상사사번 컬럼이 있고, 그 값이 다시 사원 테이블의 사번을 참조하면 계층형 관계야."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "상호배타 관계는 하나의 인스턴스가 여러 부모 후보 중 하나와만 연결되는 구조야."
        },
        {
          kind: "example",
          title: "결제 예시",
          body: "결제 건 하나가 카드 결제 또는 계좌이체 중 하나로만 처리되도록 모델링하는 경우야."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "트랜잭션은 여러 SQL을 하나의 논리 작업 단위로 묶어 처리하는 개념이야."
        },
        {
          kind: "example",
          title: "계좌이체 예시",
          body: "A 계좌에서 1만원을 빼고 B 계좌에 1만원을 더하는 두 작업은 함께 성공하거나 함께 취소되어야 해."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "tip",
          title: "트레이드오프",
          body: "격리수준이 높을수록 일관성은 좋아지지만 동시 처리 성능은 떨어질 수 있어."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "NULL은 아직 값이 없거나 알 수 없다는 뜻이야. 0이나 빈 문자열과 달라."
        },
        {
          kind: "callout",
          tone: "warn",
          title: "비교 함정",
          body: "col = NULL은 원하는 결과를 주지 않아. NULL 여부는 IS NULL, IS NOT NULL로 확인해."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "집계함수 대부분은 NULL을 제외하고 계산해. 단, COUNT(*)는 행 수를 세므로 NULL이 있어도 포함돼."
        },
        {
          kind: "example",
          title: "평균 예시",
          body: "점수 90, NULL, 80이면 AVG(점수)는 (90+80)/2야. NULL을 0으로 바꾸면 평균이 달라져."
        }
      ]
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "tip",
          title: "명시하기",
          body: "ORDER BY col NULLS FIRST 또는 NULLS LAST로 위치를 지정할 수 있어."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "인조식별자는 의미 없는 내부 ID라서 업무 정책 변화와 개인정보 노출에 강해."
        },
        {
          kind: "callout",
          tone: "warn",
          title: "단점도 있음",
          body: "의미가 없기 때문에 같은 사람이 중복 등록되는 것을 막으려면 별도의 UNIQUE 제약이나 검증이 필요해."
        }
      ]
    },
    {
      ...
      blocks: [
        {
          kind: "intro",
          body: "PK는 인조식별자로 안정적으로 두고, 업무상 중복되면 안 되는 값은 UNIQUE로 관리하는 방식이 흔해."
        },
        {
          kind: "example",
          title: "학생 예시",
          body: "학생(id PK, 학번 UNIQUE, 이름, 학과). 내부 연결은 id로 하고, 학번 중복은 UNIQUE로 막아."
        }
      ]
    }
  ]
