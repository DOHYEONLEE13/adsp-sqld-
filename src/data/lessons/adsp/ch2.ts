...
const ADSP_2_1: Lesson = {
  ...
  hook: '"문제를 안다 × 방법을 안다" — 2×2 칸이 분석을 결정해.',
  estimatedMinutes: 9,
  steps: [
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '"What 을 안다 / 모른다" × "How 를 안다 / 모른다" 의 2×2. 각 칸이 다른 분석 전략을 요구해.',
        },
        {
          kind: 'table',
          title: 'What × How = 4유형',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Optimization(최적화) 는 What(풀 문제) 도 분명하고 How(푸는 방법) 도 갖춰진 가장 안정된 상태야. 새로운 모델을 만드는 게 아니라 이미 잘 작동하는 모델·프로세스의 효율을 한 단계 더 끌어올리는 일 — 파라미터 튜닝, 자원 배분 재조정, 운영 최적화.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Solution(방법 탐색) 은 What 은 분명("어떤 결과를 얻고 싶은지" 명확) 한데 How 가 비어있는 단계야. 여러 분석 기법·모델을 후보로 두고 "이 문제엔 어느 기법이 가장 잘 맞을까?" 를 비교 실험하는 일.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Insight(대상 발견) 는 How(분석 도구·기법) 는 갖춰져 있지만 What(어디에 적용할까) 이 비어 있는 단계야. "우리 회사가 잘하는 회귀·군집·EDA 를 어디에 써먹지?" 라는 질문에서 시작해 데이터에서 가치 있는 분석 대상을 발굴하는 일.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Discovery(전방위 탐험) 는 What 도 How 도 모두 비어있는 가장 모험적인 영역이야. 가설·문제 정의부터 시작해서 어떤 데이터가 의미 있는지, 어떤 기법으로 접근할지까지 전부 만들어가는 R&D 적 분석.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '하향식(Top-down) 접근은 풀어야 할 문제가 명확할 때 쓰는 정석. 4단계 순서가 시험에 그대로 나와 — "탐정해타".',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '문제 탐색(Exploration) 은 풀어야 할 문제 후보를 빠짐없이 모으는 단계야. 처음부터 한두 개로 좁히지 않고 일단 넓게 펼쳐놓는 게 핵심 — 회사 안과 밖, 두 관점을 교차하면 사각지대를 줄일 수 있어.',
        },
        {
          kind: 'section',
          title: '두 렌즈로 보기 — 내부 / 외부',
          body:
            '내부 관점("업·제·고·에"): 업무 프로세스의 비효율, 제품의 결함·기회, 고객 경험의 불편, 외부 협력사·공급망 이슈. 외부 관점(STEEP): Social(소셜·문화 트렌드), Technology(신기술 등장), Economic(경기·환율), Environment(기후·자원), Political(규제·정책). 이 5축을 한 바퀴 돌면 외부 환경 변화로 인한 신규 문제를 놓치지 않아.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '문제 정의(Definition) 는 탐색에서 모은 후보 중 한 개를 골라 "데이터로 풀 수 있는 형태" 로 다시 쓰는 단계야. "요즘 매출이 좀 부진해" 같은 구어체 비즈니스 문제는 분석가가 그대로 풀 수 없어. 측정 가능한 지표·시점·범위로 좁혀줘야 해.',
        },
        {
          kind: 'section',
          title: '예시로 — 비즈니스 → 분석 번역',
          body:
            '"고객들이 빠져나가는 것 같다" → "최근 3개월 활성 고객 중 다음 달 이탈할 사용자 식별 → 이탈률 5%p 감소" / "신상품이 안 팔린다" → "출시 후 4주차 재구매율 < 12% 인 상품 사전 선별 → 진열 우선순위 조정" / "재고가 자주 부족하다" → "주별 SKU 단위 수요 예측 → 안전재고 재산정". 모두 (1) 측정 단위 (2) 시간 범위 (3) 의사결정 행동이 분명해.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '해결방안 탐색(Solution) 은 정의된 분석 문제에 대해 풀이 방법 후보를 나열하고 비교하는 단계야. 어떤 알고리즘으로? 어떤 데이터를? 어떤 시스템 위에서? — 도구·기법·데이터 소스의 후보를 줄세우고 일차 비교를 해. 실제로 운영에 올리기 전 단계.',
        },
        {
          kind: 'section',
          title: '예시로 — 후보 비교',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '타당성 검토(Feasibility) 는 실제 프로젝트 착수 직전, "정말 진행 가능한가?" 를 3축으로 점검하는 마지막 관문이야. 한 축이라도 막히면 앞 단계로 돌아가 후보를 다시 고려해야 해.',
        },
        {
          kind: 'section',
          title: '3축으로 보기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Waterfall(폭포수) 은 단계가 순차적으로 진행되어 한 번 다음 단계로 가면 이전으로 되돌리기 어려운 방법론이야. 폭포처럼 위에서 아래로 한 방향으로만 흐른다는 뜻에서 이름이 붙었어. 요구사항이 처음부터 명확하고 변경이 거의 없는 프로젝트에서만 효율적이야.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
          body:
            '정부 행정망 시스템 — 법령으로 요구사항이 고정 / 항공기 제어 SW — 안전 표준이 미리 명시 / 대형 SI 프로젝트에서 발주처가 요구사항을 사전 문서화 후 RFP 발주. 모두 "처음부터 무엇을 만들지가 명확" 한 케이스라 단계 간 되돌아갈 일이 적어. 반대로 요구가 자주 바뀌는 스타트업 앱이라면 부적합.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Prototype(시제품) 방법론은 요구사항이 처음부터 분명하지 않을 때 일단 동작하는 시제품을 빠르게 만들어 사용자에게 보여주고 피드백을 받아 개선하는 반복 사이클이야. "말로 설명해도 사용자가 정확히 뭘 원하는지 모를 때" 가장 강력 — 사용자도 만든 걸 봐야 진짜 원하는 걸 깨닫는 경우가 많거든요.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Spiral(나선형) 은 반복 사이클 + 각 사이클마다 위험 분석을 결합한 방법론이야. 한 사이클당 4단계(계획·위험분석·개발·평가) 를 돌고, 다음 사이클로 갈지 멈출지를 위험 평가 결과로 결정해. 신기술·대형·고위험 프로젝트에 적합 — 한 번의 실패가 너무 비싸기 때문에 매 단계 점검이 필요.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Agile(애자일) 은 2~4주 짧은 반복 주기(스프린트) 를 돌며 매 스프린트마다 동작하는 결과물을 만들고 변경을 적극 수용하는 방법론이야. "요구사항이 자주 바뀐다" 를 약점이 아닌 자연스러운 사실로 받아들이는 게 철학적 차이 — Waterfall 이 변경을 비용으로 본다면 Agile 은 변경을 학습으로 봐.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'RAD(Rapid Application Development) 는 60~90일 같은 명확한 단기 데드라인 안에 결과물을 내야 하는 프로젝트에 쓰는 방법론이야. 미리 만들어둔 모듈·컴포넌트·라이브러리를 빠르게 조립해 단기간에 동작하는 시스템을 완성. Agile 과 비슷해 보이지만 RAD 는 더 짧은 단발성 완료 사이클이 특징이야.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '과제 우선순위는 "지금 급한가" × "얼마나 어려운가" 의 2×2 매트릭스로 분류. 각 칸이 다른 행동을 권해.',
        },
        {
          kind: 'table',
          headers: ['시급성', '난이도', '권고'],
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Now × Easy = 1순위. 시급성도 높고 난이도도 낮아 망설일 이유가 없는 과제야. 보통 데이터·인프라가 이미 갖춰져 있어 며칠~몇 주 안에 결과를 낼 수 있어. 분석 조직이 처음 들어왔을 때 "조직의 신뢰" 를 빠르게 쌓는 카드로도 사용돼.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Now × Difficult = 시급성은 높은데 난이도도 높은 영역. 지금 안 하면 다른 분석들이 모두 막히지만, 한 번에 끝낼 수 없는 큰 투자가 필요한 과제들이 여기 와. 단계적 로드맵·예산 분할·점진적 인도(MVP → 확장) 가 정석.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Future × Easy = 시급하진 않지만 부담도 적은 영역. 분석 팀이 한가할 때 처리하면 작은 가치라도 확보할 수 있는 보너스 후보들이야. 다만 이 영역에 자원을 너무 많이 쓰면 1·2순위 핵심 과제를 놓치기 쉬워요.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'Future × Difficult = 후순위. 지금 시작하기엔 비용 부담이 크고 즉각 효용도 낮은 영역이야. 보통 R&D·신기술 검토·실험적 프로젝트가 여기 분류돼. 회사 자원이 충분하고 미래 대비를 명확히 할 때만 착수.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '조직(Organization) 축은 분석 활동의 R&R · 보고 라인 · CoE / 분산 / 기능 같은 조직 형태를 정해.',
        },
        {
          kind: 'section',
          title: '구분 팁',
    ...
    // ─── 성숙도 4단계 (도활확최) — 1 step → 5 substeps ───
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            '집중형(CoE) → 기능형 → 분산형. 성숙도가 올라갈수록 DSCoE 가 전사 분산으로 퍼져나가.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '도입(Introduction) 은 회사의 분석이 일부 개인의 자발적 시도 수준에 머무는 단계야. 회사가 공식적으로 "분석을 하자" 라고 말한 적은 없고, 호기심 많은 한두 명이 엑셀·구글 시트로 자기 업무를 분석해 보는 정도. 표준·예산·플랫폼 모두 부재해.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '활용(Adoption) 은 한두 부서가 분석을 정기 업무로 통합한 단계야. 도입과 다른 점은 (1) 개인이 아니라 부서 차원의 활동이 되었다는 것 (2) 정기적으로(주간·월간) 결과를 만들어 의사결정에 쓴다는 것. 다만 전사 차원의 통일된 도구·플랫폼은 아직 없어 부서마다 도구가 제각각이야.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '확산(Diffusion) 은 전사 차원에서 분석을 표준화하는 단계야. 부서마다 흩어져 있던 데이터·도구를 통합 플랫폼 위로 모으고, 거버넌스 정책(누가 어떤 데이터를 볼 수 있는지·품질 기준은 어떻게 되는지) 을 공식화해. 분석이 "있으면 좋은" 게 아니라 "모든 부서가 공유하는 인프라" 가 돼.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '최적화(Optimization) 는 분석이 조직 의사결정의 디폴트가 된 단계야. 회의에서 데이터 근거 없이 의견을 내면 통과되지 않을 정도로 분석이 일상에 내재화돼. 한 발 더 나아가 "분석 자체의 ROI 와 효율" 을 다시 분석해 최적화하는 메타 단계까지 진행돼.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '"분석 거버넌스 5축 (시조프인데)" 와 "데이터 거버넌스 3요소 (원조프)" 는 별개. 시험에서 두 축을 섞어 오답 선지로 주는 게 흔해.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '원칙(Principle) 은 회사가 데이터를 다룰 때 따라야 할 기본 규범·정책이야. "헌법" 에 비유하면 가장 정확해. 보안 정책, 접근 권한 정책, 데이터 품질 정책, 활용 정책 — 모든 일상 결정이 이 원칙에서 출발해.',
        },
        {
          kind: 'section',
          title: '구체 사례로 감잡기',
          body:
            '"고객 개인정보는 마케팅 목적 외에는 사용 금지" / "재무 거래 데이터는 임원·재무팀만 조회 가능" / "외부 업체와 공유하는 모든 데이터는 익명화 후 송출" / "데이터 품질 등급 A·B·C 의 정의와 적용 범위". 모두 회사가 데이터에 대해 미리 약속한 큰 규칙들. 이 규칙을 누가 책임지고 굴리는지(조직), 매일 어떤 절차로 점검하는지(프로세스) 와는 분리돼.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '조직(Organization) 은 데이터 거버넌스의 원칙을 실제로 굴릴 사람·역할 구조야. 아무리 좋은 정책도 책임자가 없으면 종이일 뿐 — 누가 어떤 데이터에 대해 결정권을 가지고, 누가 일상 운영을 담당할지를 명확히 해.',
        },
        {
          kind: 'section',
          title: '대표 역할 3가지',
          body:
            'CDO(Chief Data Officer) — 회사 전체의 데이터 전략·정책을 총괄하는 임원. 데이터 오너(Data Owner) — 특정 데이터(예: 고객 데이터, 재무 데이터) 의 최종 책임자. 보통 해당 비즈니스 부서장이 맡아. 데이터 스튜어드(Data Steward) — 일상적으로 데이터 품질 점검, 메타데이터 관리, 표준 코드 적용 등 실무를 담당하는 역할.',
        },
        {
          kind: 'callout',
          tone: 'tip',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '프로세스(Process) 는 원칙을 일상 운영에 녹이는 실행 절차야. "매일·매주 어떤 일을 어떤 순서로 하는가" 가 프로세스. 원칙(헌법) 이 있고 조직(책임자) 이 정해졌어도 이 일상 절차가 없으면 결국 운영이 안 돼.',
        },
        {
          kind: 'keypoints',
          title: '주요 활동 4가지',
      ...
      blocks: [
        {
          ...
          title: '데이터에서 먼저 시작한다',
          body:
            '대량의 로그·거래 데이터를 들여다보고 패턴·이상 징후에서 분석 주제를 "발견" 하는 방식. 비지도 학습·EDA 가 주 무기야. 문제를 미리 정의하지 않고 데이터가 말하게 하는 것.',
        },
        {
          kind: 'example',
          title: '언제 유리한가',
      ...
      blocks: [
        {
          ...
          title: '하향식 ↔ 상향식을 왕복',
          body:
            '하향식으로 가설을 세우고, 상향식으로 데이터를 점검하고, 다시 가설을 수정하는 반복 운동. 이 혼합 접근을 디자인 씽킹이라 불러. 현대 기업들이 가장 선호하는 방식.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
          ...
          body:
            '통합 · 이해관계자 · 범위 · 일정 · 원가 · 품질 · 자원 · 의사소통 · 위험 · 조달. 과제도 프로젝트로 관리되어야 해.',
        },
      ],
    },
    // ─── 분석 과제 정의서 — 1 step ───
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 과제 정의서는 분석 프로젝트를 시작하기 전 합의해서 작성하는 문서야. 진행 중 "범위가 갑자기 바뀐다", "자원이 부족하다" 같은 분쟁을 사전에 방지하는 헌장 역할을 해.',
        },
        {
          kind: 'keypoints',
          title: '5 핵심 항목',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 준비도(Analytics Readiness) 는 조직이 분석을 시작·확장할 만한 토대가 갖춰졌는지 6 영역으로 점검해. 분석 거버넌스 5축(시조프인데) 와 헷갈리지 마 — 거버넌스는 굴리는 틀, 준비도는 시작 전 점검표.',
        },
        {
          kind: 'callout',
          tone: 'mnemonic',
        ...
        },
        {
          ...
          title: '"비용·예산" 함정',
          body:
            '6 영역에 "비용·예산" 은 포함되지 않아. 시험에 자주 나오는 오답 선지.',
        },
        {
          kind: 'table',
          headers: ['준비도', '성숙도', '유형'],
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 업무 영역은 조직이 분석할 만한 비즈니스 과제를 얼마나 발굴·정의할 수 있느냐를 봐. "어떤 분석이 필요한지" 조차 못 짚으면 다음 단계 진행 X.',
        },
        {
          kind: 'section',
          title: '구분 팁',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 인력·조직 영역은 조직 내 분석 인력 보유 수준 + 분석 전담 조직 (CDO·CoE 등) 의 명확성을 봐.',
        },
        {
          kind: 'section',
          title: '구분 팁',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 기법 영역은 통계·머신러닝·딥러닝 등 분석 알고리즘과 기법을 어디까지 활용할 수 있는가를 봐.',
        },
        {
          kind: 'section',
          title: '구분 팁',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 데이터 영역은 분석에 사용할 수 있는 데이터의 확보 가능성·품질·표준화 수준을 봐.',
        },
        {
          kind: 'section',
          title: '구분 팁',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            '분석 문화 영역은 조직이 데이터 기반 의사결정을 일상으로 받아들이는 문화 수준을 봐. 분석이 의사결정의 디폴트인가, 아니면 "감으로 결정" 후 사후 정당화용인가.',
        },
        {
          kind: 'section',
          title: '구분 팁',
      ...
      blocks: [
        {
          kind: 'intro',
          body:
            'IT 인프라 영역은 분석을 돌릴 컴퓨팅 환경·플랫폼·도구 보유 수준이야. 분석 거버넌스 5축의 "시스템" 과 동일한 개념.',
        },
        {
          kind: 'section',
          title: '구분 팁',
