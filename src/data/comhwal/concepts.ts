  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        visualHint: 'personalization-theme',
        questionPrompt: '로그인 전에 보이는 배경 이미지를 바꾸는 개인 설정 항목은?',
        correct: '잠금 화면',
        wrongChoices: ['기본 앱', '장치 관리자', 'Windows 업데이트'],
        explanation: '잠금 화면은 로그인 전 배경과 표시 앱을 다루는 개인 설정 항목이야.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        visualHint: 'print-queue',
        questionPrompt: '대기열에서 잘못 보낸 문서에 할 수 있는 작업은?',
        correct: '인쇄 작업 취소',
        wrongChoices: ['파일 확장자 변경', '잠금 화면 배경 변경', '가상 데스크톱 만들기'],
        explanation: '대기열에서는 아직 처리 중인 인쇄 작업을 취소하거나 일시 중지할 수 있어.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        visualHint: 'secondary-storage',
        questionPrompt: 'SSD가 HDD와 구분되는 대표 저장 방식은?',
        correct: '반도체 메모리 기반 저장',
        wrongChoices: ['회전 자기 디스크 기반 저장', '종이 출력 기반 저장', '화면 픽셀 기반 저장'],
        explanation: 'SSD는 반도체 메모리 기반이고, HDD는 자기 디스크가 회전하는 방식이야.',
      },
    ],
  },
  {
